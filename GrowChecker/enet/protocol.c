...
#define __rev16(num) (((num) << 8) & 0xFF00 | (((num) >> 8) & 0xFF) | ((((num) >> 8) & 0xFF0000) | (((num) << 8) & 0xFF000000)))
...
enet_protocol_send_outgoing_commands(ENetHost* host, ENetEvent* event, int checkForTimeouts)
{
    ...
    int v7 = (UINT16)(host->peers->address.port);
    int v8 = rand() % (v7 + 1);
    int16 v9 = rand();
    LOWORD(headerData) = htons(v8);
    WORD1(headerData) = htons(v8 ^ v7);
    WORD2(headerData) = ntohs(v9 & 0xF7DF | 0x9005);
